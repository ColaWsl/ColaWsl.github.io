...
// 配置（需要自己修改）
const gitDefault = {
  clientID: 'Ov23lini9sTEiEIz2swA', // !需要改成自己的clientID
  clientSecret: '752163ed10460fb42b2588ded605c1c6222356bb', // !需要改成自己的clientSecret
  repo: 'gitalk-vitepress', // !需要改成自己创建的评论仓库
  owner: 'ColaWsl', // !需要改成自己的用户名
  admin: ['ColaWsl'], // !需要改成自己的用户名
